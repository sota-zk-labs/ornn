...
//
//
// impl Generator<ASTNode> for MoveGenerator {
//     fn generate(&self, ast: &ASTNode) -> (String, usize) {
//         let mut sub_expression_map = HashMap::new();
//         let mut code = String::new();
//         let mut temp_var_counter = 0;
//         let str = Self::generate_code_recursive(self, ast, &mut sub_expression_map, &mut code, &mut temp_var_counter);
//         if temp_var_counter == 0 {
//             return (str, 0)
//             // return format!("{{\nlet val := {}\nmstore({}, val)\n}}", str, "0x00")
//         }
//         return (code, temp_var_counter)
...
//
//         let (solidity_code, _) = MoveGenerator::generate(&ast, &registry);
